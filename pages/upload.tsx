...
const Upload = ()=>{
    ...
    return (    
        <div className="flex w-full h-full absolute left-0 top-[60px] mb-10 py-10 lg:pt-20  justify-center overflow-y-scroll">
            <div className="bg-white rounded-lg xl:h-[80vh] w-[94%] flex gap-6 flex-wrap justify-between items-center p-14 pt-6">
                <div>
                    <div>
                ...
                <div className="flex flex-col gap-3 pb-36 md:pb-10">
                        ...
                        <select onChange={(e)=>setCategory(e.target.value)} className="outline-none border-2 border-gray-200 text-md capitalize lg:p-4 p-2 rounded cursor-pointer">
                            {topics.map((topic) => (
                                <option
                                 key={topic.name}
                                 className="outline-none capitalize bg-white text-gray-7000 text-md p-2 hover:bg-slate-300"
                                >
                                    {topic.name}
                                </option>
                            ))}
                        ...
                        <div className="flex gap-6 mt-10">
                            ...
                            <button
                                onClick={handlePost}
                                type="button"
                                className="border-[#F51997] border-2 text-md font-medium p-2 rounded w-28 lg:W-44 outline-none"
                            >
                                Post
                            </button>
                        </div>
